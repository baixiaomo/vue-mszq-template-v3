const theme = {
  ...
  dataZoom: {
    ...
    dataBackgroundColor: '#0D1125',
    fillerColor: '#232D4E',
    showDataShadow: false,
    height: 5,
    borderColor: 'transparent',
    backgroundColor: '#0D1125',
    handleIcon: 'image://data:image/png;base64,',
    handleSize: 20,
    handleColor: '#D4B381',
    handleStyle: {
      shadowBlur: 0
